...
import { buildTaskFrontmatter, serializeProject, serializeTask, taskFilePath } from './YamlSerializer'
    ...
    try {
      ...
      if (file instanceof TFile) {
        ...
        await this.app.vault.process(file, (content) => {
          ...
          return serializeProject(project, this.getStatuses())
        })
        this.hydratedBodies.add(project)
      } else {
    ...
    try {
      ...
      if (existing instanceof TFile) {
        ...
        await this.app.vault.process(existing, (content) => {
          ...
          return serializeTask(task, project, parentTask, this.getStatuses())
        })
      } else {
