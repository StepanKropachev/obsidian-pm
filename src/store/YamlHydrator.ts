import type { CustomFieldDef, Project, SavedView, StatusConfig, Task, ViewMode } from '../types'
...
export function hydrateProjectFromFrontmatter(
  ...
  return {
    ...
    statuses: hydrateProjectStatuses(frontmatter.statuses),
    taskIndex: new Map()
  }
}

/** Read a project's own status definitions, dropping malformed entries. Absent or empty = inherit global. */
function hydrateProjectStatuses(raw: unknown): StatusConfig[] | undefined {
