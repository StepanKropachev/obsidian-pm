...
- **Per-project statuses** — A project can define its own workflow: its statuses replace the global ones everywhere in that project, from kanban columns to pickers. Statuses still in use by tasks always stay visible.
